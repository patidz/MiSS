...
public class Tree extends AbstractTreeModel{ // HWINDData
    ...
    protected boolean standing;         // TODO rozroznienie na broken i fallen
    ...
    public int calculateTreeForce( double speed){
        double totalBendingMoment = totalBendingMoment(this, speed);
